package src.graph.implementation;

public class GraphDirectAndWeightImplementation {
    public static void main(String[] args) {
        GraphDirectAndWeight g = new GraphDirectAndWeight(4);
        g.addVertexData(0, 'A');
        g.addVertexData(1, 'B');
        g.addVertexData(2, 'C');
        g.addVertexData(3, 'D');
...
class GraphDirectAndWeight {
    private Integer[][] adjMatrix;
    private char[] vertexData;
    private int size;

    public GraphDirectAndWeight(int size) {
        this.size = size;
